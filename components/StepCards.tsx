...
export default function StepCards() {
  ...
  return (
    <div ref={ref} className="mt-14 grid gap-8 md:grid-cols-3 step-connector">
      {STEPS.map((card, i) => (
        <div
          key={card.title}
          className="card card-hover flex h-full flex-col gap-5 p-10 relative z-10"
          style={{
        ...
        >
          <div className="mb-1">{STEP_ICONS[i]}</div>
          <div
