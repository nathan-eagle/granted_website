...
Private foundations operate differently from federal agencies. There is no single portal equivalent to Grants.gov. Instead, you need to research foundations individually. Thousands of private foundations fund human services work including housing, food security, and youth development -- [browse human services foundations in the Granted directory](/foundations/human-services) to start identifying prospects.
...
For nonprofits looking to build a sustainable grants pipeline without hiring a full-time grants team, [see how Granted supports nonprofit organizations](/for/nonprofits) at every stage of the process.
