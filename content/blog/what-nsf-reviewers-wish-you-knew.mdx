...
description: 'NSF reviewers reveal what makes a winning grant proposal. Tips on Intellectual Merit, Broader Impacts, storytelling, and measurable outcomes.'
date: '2026-02-02'
...
Granted's AI coaching applies these same reviewer insights to your draft in real time, helping you address Intellectual Merit and Broader Impacts with the specificity panelists want to see -- [learn how Granted supports researchers](/for/researchers).
...
- [From Rejection to Resubmission: Bouncing Back After an Unsuccessful NSF Grant Proposal](/blog/from-rejection-to-resubmission-bouncing-back-after-an-unsuccessful-nsf-grant-proposal)
