...
Several major funding streams are actively supporting coastal resilience work right now. Beyond federal agencies, private foundations are increasingly investing in conservation and climate resilience -- [browse environment foundations in the Granted directory](/foundations/environment) to identify additional funding sources for your coastal work.
...
Tools like [Granted](/) can help you build a stronger grant proposal, from analyzing NOFO requirements to drafting compelling project narratives. For organizations working on habitat restoration, coastal adaptation, or community resilience, [see how Granted supports environmental organizations](/for/environmental) pursuing NOAA, NFWF, and Sea Grant funding.
