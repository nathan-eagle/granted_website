...
Private foundations are major funders of education programs like the one described below -- [browse education foundations in the Granted directory](/foundations/education) to find potential funders for your STEM initiative.
...
If you are building a grant proposal and want help structuring the logic model alongside the rest of the narrative, [Granted AI](/) walks you through the program design process and ensures your logic model aligns with the evaluation plan, budget, and project narrative. Writing your first proposal and unsure how to connect the logic model to the rest of the application? [Granted's first-time applicant tools](/for/first-time) guide you through the full process step by step.
