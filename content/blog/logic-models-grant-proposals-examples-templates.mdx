...
If you are building a grant proposal and want help structuring the logic model alongside the rest of the narrative, [Granted AI](https://grantedai.com) walks you through the program design process and ensures your logic model aligns with the evaluation plan, budget, and project narrative.
