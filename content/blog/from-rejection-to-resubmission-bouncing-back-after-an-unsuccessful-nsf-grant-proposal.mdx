---
title: 'National Science Foundation Rejections: Why NSF Proposals Get Rejected & How to Resubmit Successfully'
description: 'NSF rejects ~75% of grant proposals. Learn the most common reasons for National Science Foundation rejections, how to interpret reviewer feedback, and proven strategies for a successful resubmission.'
date: '2025-08-17'
...
## Why Does the National Science Foundation Reject So Many Proposals?

National Science Foundation rejections are more common than most researchers expect. The NSF funds roughly **25% of proposals** it receives, meaning three out of four applicants face rejection in any given cycle. In FY 2024, the NSF received over 40,000 proposals and declined the majority.

**The most common reasons for NSF grant rejections include:**

- **Weak intellectual merit or broader impacts** — the two primary review criteria
- **Lack of clarity** in the research plan or objectives
- **Insufficient preliminary data** to support feasibility
- **Poor alignment** between the proposed work and the program solicitation
- **Budget issues** — unrealistic costs or inadequate justification

If your NSF proposal was rejected, you're in good company. The path from rejection to a funded resubmission is well-traveled, and understanding *why* proposals get rejected is the first step toward getting funded.

Below, we cover how to analyze your reviewer feedback, strengthen your proposal, and submit a competitive resubmission.
...
Granted's AI coaching helps researchers translate panel feedback into targeted revisions and strengthen both Intellectual Merit and Broader Impacts for resubmission -- [see how Granted supports researchers](/for/researchers).

## Keep Reading

- [What NSF Reviewers Wish You Knew](/blog/what-nsf-reviewers-wish-you-knew)
- [NSF Peer Review: Making Your Grant Proposal Shine](/blog/nsf-grant-peer-review-process-understanding-the-criteria-and-making-your-proposal-shine)
- [NSF Grant Abstracts: Crafting a Compelling Research Summary](/blog/nsf-grant-proposal-abstracts-crafting-a-compelling-summary-for-your-science-research)
