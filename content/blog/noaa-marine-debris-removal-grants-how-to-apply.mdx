...
Private foundations also fund marine conservation and coastal cleanup work alongside federal programs -- [browse environment foundations in the Granted directory](/foundations/environment) to diversify your funding strategy.
