...
These programs support graduate study within the United States, typically in STEM or policy fields. In addition to government-funded fellowships, hundreds of private foundations offer scholarships and education grants -- [browse education foundations in the Granted directory](/foundations/education) to find opportunities that align with your field of study.
...
The common thread across every program: specificity, authenticity, and preparation. Know what the program values, demonstrate that you embody those values through concrete evidence, and invest the time to make your application exceptional. If you are applying for competitive funding for the first time and want structured help crafting your proposal and personal statement, [Granted's first-time applicant tools](/for/first-time) walk you through the process section by section.
