...
Write your evaluation plan as if the funder will read it first. In many review processes, they do. A proposal with a rigorous, specific, well-budgeted evaluation plan signals that you are an organization worth investing in, regardless of the specific program you are proposing. If you are building an evaluation plan for your first grant application and want help structuring outcomes that align with the funder's criteria, [Granted's first-time applicant coaching](/for/first-time) guides you through every section including evaluation.
