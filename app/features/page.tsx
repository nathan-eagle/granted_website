        ...
        <section className="border-b border-white/10">
          <Container className="py-28 md:py-36 text-center">
            ...
            <div className="mt-10 flex justify-center gap-4">
              ...
              <ButtonLink href="/platform" variant="ghost" className="border-white/20 text-white hover:bg-white/10 hover:border-white/30">Learn about the technology</ButtonLink>
            </div>
          </Container>
        </section>
